    ...
    return (
      <div className="min-h-screen bg-slate-900 text-white p-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-4">Transferai</h1>
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <header className="bg-slate-800 border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold">🤝 Transferų Rinka</h1>
          </div>
          <div className="flex items-center gap-4">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-bold mb-2">Žaidėjų Perkedojimas</h2>
          <p className="text-slate-400">
            Siūlykite sutartis, stebėkite atsakymus, plečia savo komandą.
          </p>
        </div>
